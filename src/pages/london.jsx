  ...
  return (
    <Layout>
      ...
      <div className="relative w-full h-screen">
        ...
        {/* Content Overlay */}
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 pt-20 text-center text-white bg-black bg-opacity-50">
          <motion.h1
          ...
          >
            {!isEnvelopeOpen ? (
              ...
              <motion.img
                src={ENVELOPE_CLOSED}
                alt="Closed Envelope"
                className="h-auto cursor-pointer w-84"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => setIsEnvelopeOpen(true)}
              />
            ) : (
              // Open Envelope with Text Overlay
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 1 }}
              ...
              >
                ...
                <motion.p
                  ...
                  className="absolute top-[20%] left-1/6 transform -translate-x-1/2 -translate-y-1/2 text-sm text-black font-semibold w-full px-16"
                >
          ...
          {/* Jeans Image + Text Revealed on Click */}
          {showJeans && (
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
            ...
            >
              ...
              <p className="mt-4 text-xl italic text-gray-200">
                ...
                <span className="font-black text-blue-300">
                  {" "}
                  POOJANTIR (PJTR on the stock market)
                </span>{" "}
                that will force EVERYONE on Earth to wear these floral jeans…
                FOREVER
              </p>
            </motion.div>
          )}
          ...
          <div className="relative flex gap-8 mt-8">
            ...
            <motion.div
              ...
              className="flex flex-col items-center"
            >
              <div className="flex items-center justify-center w-24 h-24 bg-white border-4 border-yellow-500 rounded-full">
